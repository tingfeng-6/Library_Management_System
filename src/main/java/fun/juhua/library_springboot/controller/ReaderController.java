...
public class ReaderController {
    ...
    public String toBookshelf(String bookName, String bookID, String bookAuthor, String isbn, String tag, String publishYm, HttpSession session, Model model) {
        List<Book> bookList = bookService.getBookList(bookName, bookID, bookAuthor, isbn, tag, publishYm);
