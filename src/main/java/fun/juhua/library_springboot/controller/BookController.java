...
public class BookController {
    ...
    public String toBookList(String bookName, String bookID, String bookAuthor, String isbn, String tag, String publishYm, Model model) {
        List<Book> bookList = bookServiceImpl.getBookList(bookName, bookID, bookAuthor, isbn, tag, publishYm);
